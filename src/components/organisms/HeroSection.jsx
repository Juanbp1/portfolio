...
const HeroSection = () => {
  return (
    <div className="mx-auto flex h-[96vh] max-w-container items-center justify-between" id="heroSection" data-testid="heroSection">
      <HeroBanner />
      <img src={yoLaptop} className="w-[37%] dark:hidden" />
      <img src={yoLaptopDark} className="hidden w-[37%] dark:block" />
    </div>
  );
};
